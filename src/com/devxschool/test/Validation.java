...
public class Validation {
    public static void testBill(int numberOfGuests, double billAmount, boolean isSplit, String serviceQuality, double totalAmount, double totalAmountPerGuest) {
    ...
    public static void testAlphabet(char toChar, String result) {
        ...
        } else if (!result.equalsIgnoreCase("not a letter")){
    ...
    public static void testDaycare(double age, boolean agreement, String childClass) {
        if (agreement) {
            ...
            /*if (!(childClass == null || childClass.isEmpty())) {
                throw new RuntimeException("Childclass should be null");
            }*/
            if (childClass != null && !childClass.isEmpty()) {
                throw new RuntimeException("Child should not have a class.");
            }
        }
    }
}
