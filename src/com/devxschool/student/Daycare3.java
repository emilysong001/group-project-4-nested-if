...
//ignore this
    ...
    public static int getPrice(double age) {
        int price;
        if (age < 3) {
            price = 2000;
        } else {
    ...
    public static boolean isAgreed(Scanner scan) {
        System.out.println("Would you like to apply?");
        boolean agreement = scan.nextBoolean();
        return agreement;
    }
    public static String getClassRoom(double age) {
        String childOfClass;
        if (age < 3) {
            childOfClass = "Star";
        } else {
